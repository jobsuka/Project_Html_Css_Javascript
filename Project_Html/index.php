...
<html lang="en">
<head>
<title>Jobsuka Project Html</title>
<meta charset="UTF-8">
...
<div class="w3-main" style="margin-left:300px">
  ...
  <div class="w3-row">
    <div class="w3-third">
      <img src="src//images/natureboy.jpeg" style="width:100%" onclick="onClick(this)" alt="A boy surrounded by beautiful nature">
      <img src="src//images/girl_mountain.jpeg" style="width:100%" onclick="onClick(this)" alt="What a beautiful scenery this sunset">
      <img src="src/images/girl.jpeg" style="width:100%" onclick="onClick(this)" alt="The Beach. Me. Alone. Beautiful">
    </div>

    <div class="w3-third">
      <img src="src/images/boy.jpeg" style="width:100%" onclick="onClick(this)" alt="Quiet day at the beach. Cold, but beautiful">
      <img src="src/images/man_bench.jpeg" style="width:100%" onclick="onClick(this)" alt="Waiting for the bus in the desert">
      <img src="src/images/natureboy.jpeg" style="width:100%" onclick="onClick(this)" alt="Nature again.. At its finest!">
    </div>
    
    <div class="w3-third">
      <img src="src/images/girl.jpeg" style="width:100%" onclick="onClick(this)" alt="Canoeing again">
      <img src="src/images/girl_train.jpeg" style="width:100%" onclick="onClick(this)" alt="A girl, and a train passing">
      <img src="src/images/closegirl.jpeg" style="width:100%" onclick="onClick(this)" alt="What a beautiful day!">
    </div>
  </div>
  ...
  <div class="w3-container w3-dark-grey w3-center w3-text-light-grey w3-padding-32" id="about">
    <h4><b>About Me</b></h4>
    <img src="src/images/avatar_hat.jpeg" alt="Me" class="w3-image w3-padding-32" width="600" height="650">
    <div class="w3-content w3-justify" style="max-width:600px">
      ...
      <div>
        ...
        <p><button id="button" class="w3-button w3-light-grey w3-padding-large w3-margin-top w3-margin-bottom" onclick="function()">DOWNLOAD RESUME</button></p>
     <!-- javascript  START  -->  
        <script>
...
document.querySelector('button').onclick =function () {
  downloadFile('src/download/gooleAnalytics.js', 'gooleAnalytics.js');
}   
      </script>
<!-- javascript  END  -->  
      ...
      <div class="w3-third">
        ...
        <ul class="w3-ul">
          <li class="w3-padding-16 w3-hover-black">
            <img src="src/images/workshop.jpeg" class="w3-left w3-margin-right" style="width:50px">
            <span class="w3-large">Lorem</span><br>
            <span>Sed mattis nunc</span>
          </li>
          <li class="w3-padding-16 w3-hover-black">
            <img src="src/images/gondol.jpeg" class="w3-left w3-margin-right" style="width:50px">
